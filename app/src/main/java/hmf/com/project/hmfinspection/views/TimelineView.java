package hmf.com.project.hmfinspection.views;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, hmf.com.project.hmfinspection.R.styleable.timeline_style);
        mMarker = typedArray.getDrawable(hmf.com.project.hmfinspection.R.styleable.timeline_style_marker);
        mStartLine = typedArray.getDrawable(hmf.com.project.hmfinspection.R.styleable.timeline_style_line);
        mEndLine = typedArray.getDrawable(hmf.com.project.hmfinspection.R.styleable.timeline_style_line);
        mMarkerSize = typedArray.getDimensionPixelSize(hmf.com.project.hmfinspection.R.styleable.timeline_style_marker_size, 35);
        mLineSize = typedArray.getDimensionPixelSize(hmf.com.project.hmfinspection.R.styleable.timeline_style_line_size, 2);
        typedArray.recycle();

        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(hmf.com.project.hmfinspection.R.drawable.marker);
        }
    }
