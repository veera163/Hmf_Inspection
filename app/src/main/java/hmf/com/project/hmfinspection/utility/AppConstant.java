package hmf.com.project.hmfinspection.utility;
...
public class AppConstant {
    ...
    public static final String BASEURL = "http://13.127.197.132/";
  //  public static final String BASEURL = "http://34.195.106.0/";
    ...
    public static String ACTIVITIESPATH = "surveyActivity/tenant/getSurveyorActivities";
