...
import hmf.com.project.hmfinspection.Api.ForgotPassApi;
...
import hmf.com.project.hmfinspection.utility.AppConstant;
import hmf.com.project.hmfinspection.utility.ConnectionDetector;
import hmf.com.project.hmfinspection.utility.HttpHelper;
import hmf.com.project.hmfinspection.utility.LoggerUtils;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mEmailView, hmf.com.project.hmfinspection.R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
...
//        }
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            mPasswordView.setError(getString(hmf.com.project.hmfinspection.R.string.error_invalid_password));
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailView.setError(getString(hmf.com.project.hmfinspection.R.string.error_field_required));
            focusView = mEmailView;
            cancel = true;
        } else if (!isValidMobile(email)) {
            mEmailView.setError(getString(hmf.com.project.hmfinspection.R.string.error_invalid_email));
            focusView = mEmailView;
            cancel = true;
        }
